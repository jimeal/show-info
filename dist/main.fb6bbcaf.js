...
},{"outlayer":"node_modules/outlayer/outlayer.js","get-size":"node_modules/get-size/get-size.js","desandro-matches-selector":"node_modules/desandro-matches-selector/matches-selector.js","fizzy-ui-utils":"node_modules/fizzy-ui-utils/utils.js","./item":"node_modules/isotope-layout/js/item.js","./layout-mode":"node_modules/isotope-layout/js/layout-mode.js","./layout-modes/masonry":"node_modules/isotope-layout/js/layout-modes/masonry.js","./layout-modes/fit-rows":"node_modules/isotope-layout/js/layout-modes/fit-rows.js","./layout-modes/vertical":"node_modules/isotope-layout/js/layout-modes/vertical.js"}],"js/common.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.btn = exports.box = exports.activeClass = void 0;
exports.filter = filter;
exports.grid = exports.frame = void 0;
exports.init = init;
...
var btn = document.querySelectorAll("main ul li");
exports.btn = btn;
var grid;
exports.grid = grid;
...
function init() {
  exports.grid = grid = new _isotopeLayout.default(frame, {
    itemSelector: box,
    columnWidth: box,
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      el.addEventListener("click", function (e) {
        e.preventDefault();
        var sort = e.currentTarget.querySelector(".main__sort > li > a").getAttribute("href");
        grid.arrange({
          filter: sort
        });
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _el.classList.remove(activeClass);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
},{"isotope-layout":"node_modules/isotope-layout/js/isotope.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
},{"./common":"js/common.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
